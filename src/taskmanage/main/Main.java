...
public class Main extends Application { //remember Application

    @Override
    public void start(Stage primaryStage) throws Exception {
        // Load Task View
        FXMLLoader taskViewLoader = new FXMLLoader(getClass().getResource("/taskmanage/main/resources/TaskView.fxml"));
        ...
        FXMLLoader taskCreationLoader = new FXMLLoader(getClass().getResource("/taskmanage/main/resources/TaskCreation.fxml"));
        Parent taskCreationRoot = taskCreationLoader.load();

        // Load Calendar View
        FXMLLoader calendarViewLoader = new FXMLLoader(getClass().getResource("/taskmanage/main/resources/CalendarView.fxml"));
        Parent calendarViewRoot = calendarViewLoader.load();

        // Load Home Dashboard View
        FXMLLoader homeDashboardLoader = new FXMLLoader(getClass().getResource("/taskmanage/main/resources/HomeDashboard.fxml"));
